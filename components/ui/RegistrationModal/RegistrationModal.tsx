...
export default function RegistrationModal({
  ...
  playerData,
  closeModal,
  handleCharacterCreationAndLogin: handleCharacterCreationAndLogin,
  ...
  const handleRegistration = async () => {
    ...
    try {
      /*
        Create input payload for persistence layer
        This will be passed to the shared persistence interface,
        which routes to either localStorage or remote API based on environment configuration
      */
      ...
      // call createAccount method on persistence layer - this will switch between local and remote implementations based on environment configuration
      const response = await persistence.createAccount(accountInputData);
