  ...
  const handleLoginClick = async () => {
    ...
    if (!usernameError && !passwordError) {
      ...
      const playerSaveResponse =
        await persistence.loadPlayerSaveData(loadPlayerSaveInput);

      if (!playerSaveResponse.data || !playerSaveResponse.success) {
        console.error(
      ...
      // destructure values from persistence layer response
      ...
      if (account && player && characterData && progressionData?.currentTown) {
        ...
        // log refresh data was saved successfully
